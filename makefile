...
MOD_CPP += src/modules/Vector.cpp src/modules/Array.cpp src/modules/List.cpp src/modules/Set.cpp src/modules/Map.cpp  
...
MOD_CPP += src/modules/case.cpp src/modules/when.cpp
