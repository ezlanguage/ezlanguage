...
MOD_CPP = src/modules/String_addon.cpp src/modules/Array.cpp src/modules/Condition.cpp src/modules/Conditionnal_instruction.cpp src/modules/Declaration.cpp src/modules/Foreach.cpp src/modules/Forall.cpp src/modules/function.cpp src/modules/hashElement.cpp src/modules/hashTable.cpp src/modules/Instruction.cpp src/modules/Iterative_instruction.cpp src/modules/Node.cpp src/modules/Operator.cpp src/modules/Range.cpp src/modules/Repeat.cpp src/modules/scopeHashTable.cpp src/modules/variable.cpp src/modules/While.cpp
