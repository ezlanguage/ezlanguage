...
Variable::Variable()
	: HashElement(), _type(""), _scope(0)
{};



Variable::Variable(const string & i, const string & t, bool c)
	: HashElement(i), _type(t), _scope(0), _const(c)
{};



Variable::Variable(const Variable & v)
	: HashElement(v), _type(v.get_type()), _scope(v.get_scope()), _const(v.is_const())
{};
